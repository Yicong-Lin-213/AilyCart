...
| 🍎 iOS | 🤖 Android |
| :---: | :---: |
| <img src="./docs/expo-ios-qr.svg" width="220" alt="iOS QR Code"> | <img src="./docs/expo-android-qr.svg" width="220" alt="Android QR Code"> |
| *Scan with iOS Camera* | *Scan with Expo Go App* |
